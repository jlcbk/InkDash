...
- 主看板支持自动、竖屏、横屏三种布局模式，以及 80%-200% 字号缩放；`GET /layout?mode=...` 和 `GET /text-scale?scale=...` 会保存当前浏览器偏好。
...
- 中文文档导航、架构说明、维护检查清单、路线图、使用指南、自动化接入示例、API 参考、安全说明、systemd user service 示例、macOS launchd 示例。
